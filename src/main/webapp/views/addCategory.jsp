...
<form action="<%=request.getContextPath()%>/categories/add" method="post">
    ...
    <input type="text" name="catalogName" id="catalogName" placeholder="Nhập tên danh mục..."><br>
    <label for="description">Mô tả</label><br>
    <input type="text" name="description" id="description" placeholder="Nhập mô tả danh mục..."><br>
